      ...
      <div className="container mx-auto 2xl:max-w-5xl">
        ...
        <div className="mb-8 flex">
          ...
          <img
            src={GEUimg}
            alt="GEU image"
            className="rounded-full object-cover w-full md:w-48 h-auto my-2 md:mb-0 mx-2"
        ...
        <div className="text-right flex">
          <img
            src={ClaircoImg}
            alt="Clairco Image"
            className="rounded-full object-cover w-full md:w-48 h-auto my-2 md:mb-0 bg-white mx-2"
            style={{ boxShadow: "0 4px 8px rgba(255, 255, 255, 0.7)" }}
          />
          <div>
            ...
            <p className="text-white">
              Clairco (Aliferous Technologies Pvt Ltd) is a Bangalore startup.
              As a Software Developer intern, I contributed to interactive
              applications using React, MongoDB, Express.js, and Node.js,
              gaining hands-on experience across the software development
              lifecycle.
            </p>
          </div>
        </div>
